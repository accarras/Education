...
class HTable {
 private:
  ...
  // the given position. It is also intended to be called internally
  // because public remove function should determine the position
  // based on the hash function before it calls this one.
  bool remove(Word_counter &wordc, int position);

  // Private functions to be implemented by the student.

  // This function should find if the string s has been used as a key
  ...
  bool find(Word_counter &wordc, string s, int position);
 ...
 public:
  ...
  // return false.
  bool access(Word_counter &wordc, string s);

  // This function should first get the hash index for the string,
  // then find out if the string has been used as a key to insert an
  // object in the list at that index. If yes, it should copy that
  // object into the wordc, remove the object from that list, and
  // return true. If not, it should just return false.
  bool remove(Word_counter &wordc, string s);
