...
//declares functions
void userInput(employee eArr[], int size, string fileName);
...
int main()
{
	...
	employee *eArr = new employee[numLines];

	userInput(eArr, numLines, fileName);
	payCalc(eArr, numLines);
	outPut(eArr, numLines);
