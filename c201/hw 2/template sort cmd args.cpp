...
//enables the program to take commandline arguments
//argc is number of args, argv[] is an array of all of the arguments
{
	while (1) {
		//makes the program run again once it's done.

		int userSelectType = atoi(argv[1]);
		int userSelectSort = atoi(argv[2]);
		//uses the cmd arguments as input


		cout << "-----------------------------------------------------------" << endl;
		cout << "First argument is data type:" << endl;
		...
		cout << "-----------------------------------------------------------" << endl;
		cout << "Second argument is algorithm." << endl;
