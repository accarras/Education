...
public class DPTest {
    ...
    public void buPartitionCorrectness() {
        ...
        assertFalse(DP.bupartition(ns, 0));
        assertFalse(DP.bupartition(new Empty<>(), 7));
    }
    ...
    public void minDistance3() {
        Random r = new Random(1);
        Function<Void, DP.BASE> g = v -> DP.BASE.class.getEnumConstants()[r.nextInt(4)];
        List<DP.BASE> dna3 = List.MakeList(g, 521);
        List<DP.BASE> dna4 = List.MakeList(g, 450);
        assertEquals(337, DP.buminDistance(dna3, dna4));
    }
