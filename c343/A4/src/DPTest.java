...
public class DPTest {
    ...
    public void coinsT2 () {
        ...
        long nonDPTime = endTime - startTime;

        long startTime2 = System.nanoTime();
        DP.coinChange(coins, 100);
        long endTime2 = System.nanoTime();
        long DPTime = endTime2 - startTime2;
        assert(DPTime < nonDPTime);
    }
    ...
    @Test
    public void minDistanceCorrectness () {
        Random r = new Random(1);
        ...
        assertEquals(337, DP.minDistance(dna1,dna2));
    }
